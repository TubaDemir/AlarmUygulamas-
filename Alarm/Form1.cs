...
namespace Alarm
{
    public partial class Form1 : Form
    {
        ...
        {
            //tmrSaat, her saniye sistem saatini alıp, formun başlığında gösterir
        ...
        {   //eğer alarmZamani değişkeni ile sistem saatinin değeri aynı ise, alarm vakti geldi demektir.
            ...
            if (alarmZamani == DateTime.Now.ToShortTimeString())
        ...
        private void btnAlarmKur_Click(object sender, EventArgs e)
        {
            try
            {
                //btnAlarmKur butonu tıklandığında, alarmZamani isimli değişkene, txtSaatin textini değer olarak atadık
                alarmZamani = maskedTextBox1.Text;
                tmrZamanKontrolu.Start();
                MessageBox.Show(string.Format(@"Alarm {0} olarak kuruldu", alarmZamani ));
                this.Opacity = 0;
